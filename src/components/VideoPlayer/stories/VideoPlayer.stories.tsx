...
import { testDefaultVideoPlayer } from "./VideoPlayer.play";
...
const meta: Meta<VideoPlayerProps> = {
  ...
  argTypes: {
    thumbnailSize: {
      control: { type: "select" },
      options: ["sm", "md", "lg"],
      description: "Tamanho da thumbnail antes do play",
      table: {
    ...
    playerSize: {
      ...
      description: "Tamanho do player após iniciar o vídeo",
      table: {
